 ...
 * @property {Record<string, string> | string[]} [collectionCommands] - Custom collection commands keyed by generated method name or shorthand command list using camelized method names.
 * @property {Record<string, string> | string[]} [memberCommands] - Custom member commands keyed by generated method name or shorthand command list using camelized method names.
...
/**
 * @typedef {Omit<FrontendModelResourceConfiguration, "abilities" | "builtInCollectionCommands" | "builtInMemberCommands" | "collectionCommands" | "memberCommands"> & {
