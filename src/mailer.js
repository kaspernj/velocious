...
/** @type {MailerDeliveryPayload[]} */
const deliveries = []
/** @type {((payload: MailerDeliveryPayload) => Promise<unknown> | unknown) | null} */
 ...
 */
class MailerDelivery {
  /** @type {VelociousMailerBase} */
  mailer
   ...
   * @param {VelociousMailerBase} args.mailer - Mailer instance.
  ...
  /**
   * @returns {Promise<MailerDeliveryPayload | unknown>} - Delivered payload or handler result.
   */
  async deliverNow() {
    await this.actionPromise
    const payload = /** @type {MailerDeliveryPayload} */ (await this.mailer._buildPayload())
    const mailerClass = /** @type {typeof VelociousMailerBase} */ (this.mailer.constructor)

    return await mailerClass.deliverPayload(payload)
  }

  /**
   * @returns {Promise<string | MailerDeliveryPayload | null>} - Job id or payload in test mode.
   */
  async deliverLater() {
    await this.actionPromise
    const payload = /** @type {MailerDeliveryPayload} */ (await this.mailer._buildPayload())
...
export class VelociousMailerBase {
   ...
   * @returns {MailerDeliveryPayload} - Delivery payload.
   */
  ...
  /**
   * @returns {Promise<MailerDeliveryPayload>} - Delivery payload.
   */
  async _buildPayload() {
  ...
  /**
   * @returns {MailerDeliveryPayload[]} - Delivered payloads.
   */
  static deliveries() {
  ...
  /**
   * @param {(payload: MailerDeliveryPayload) => Promise<unknown> | unknown} handler - Delivery handler.
   * @returns {void} - No return value.
   */
  ...
  /**
   * @returns {(payload: MailerDeliveryPayload) => Promise<unknown> | unknown | null} - Handler or null.
   */
  ...
  /**
   * @param {MailerDeliveryPayload} payload - Mail delivery payload.
   * @returns {Promise<MailerDeliveryPayload | unknown>} - Handler result.
   */
