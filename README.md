...
initializer lifecycle remains intact without creating a default pool. Optional
...
`sendFile` responses are unaffected. See [docs/http-server.md](docs/http-server.md#database-free-applications).
