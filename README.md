...
* Consumer-defined per-row SQL aggregates/computations via `.queryData(...)`, with compatible projections sharing a roundtrip, on frontend and backend queries (see [docs/query-data.md](docs/query-data.md))
