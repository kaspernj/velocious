...
describe("Cli - generate - frontend-models", () => {
  it("generates frontend models from configured backend project resources", async () => {
    ...
    // Generated model files carry the auto-generated banner warning they are overwritten on regenerate.
    expect(taskContents).toContain("// This file is auto-generated by Velocious. Do not edit it manually")
    expect(taskContents).toContain("will be overwritten the next time it is generated. Run `velocious generate:frontend-models` to regenerate.")
    expect(taskContents.startsWith("// This file is auto-generated by Velocious.")).toEqual(true)
    ...
    // The dead index.js barrel is no longer generated — nothing imports it (models
    // are imported by file path, and setup.js performs the registration side-effects).
    ...
    expect(setupContents.startsWith("// This file is auto-generated by Velocious.")).toEqual(true)
    expect(setupContents).toContain("will be overwritten the next time it is generated. Run `velocious generate:frontend-models` to regenerate.")
