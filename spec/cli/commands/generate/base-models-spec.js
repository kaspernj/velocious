...
describe("Cli - generate - base-models", () => {
  ...
  it("generates boolean attribute types in base models", {tags: ["mssql"]}, async () => {
    ...
    // Generated base-model files carry the auto-generated banner warning they are overwritten on regenerate.
    expect(taskContents.startsWith("// This file is auto-generated by Velocious.")).toEqual(true)
    expect(taskContents).toContain("will be overwritten the next time it is generated. Run `velocious generate:base-models` to regenerate.")
