...
Project.hasMany("tasksWithProjectDetails", (scope) => scope.joins({project: {projectDetail: true}}), {className: "Task"})
Project.hasMany("reviewTasks", {className: "Task", foreignKey: "projectId"})
...
Project.hasOne("reviewTask", {className: "Task", foreignKey: "projectId"})
Project.hasMany("interactions", {className: "Interaction", foreignKey: "subject_id", polymorphic: true})
Project.hasOne("primaryInteraction", {className: "Interaction", dependent: "destroy", foreignKey: "subject_id", polymorphic: true})
