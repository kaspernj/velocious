...
CREATE TABLE "project_details" ("id" integer DEFAULT nextval('project_details_id_seq'::regclass) NOT NULL, "project_id" bigint NOT NULL, "note" text, "created_at" timestamp without time zone, "updated_at" timestamp without time zone, "is_active" boolean, PRIMARY KEY ("id"));
...
CREATE TABLE "tasks" ("id" integer DEFAULT nextval('tasks_id_seq'::regclass) NOT NULL, "project_id" bigint NOT NULL, "name" varchar(255), "description" text, "created_at" timestamp without time zone, "updated_at" timestamp without time zone, "is_done" boolean, PRIMARY KEY ("id"));
