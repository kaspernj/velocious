 ...
 * @returns {ReturnType<typeof JSON.parse>} Fake sync model with a rows array.
 */
export function buildFakeSyncModel() {
   ...
   * @returns {ReturnType<typeof JSON.parse>} Fake sync row.
   */
  const buildRow = (attributes) => {
    const row = {
      ...
      /** @param {Record<string, ReturnType<typeof JSON.parse>>} newAttributes - Updated attributes. @returns {Promise<void>} */
  ...
  return {
    ...
    /** @param {Record<string, ReturnType<typeof JSON.parse>>} conditions - Lookup conditions. @returns {Promise<ReturnType<typeof JSON.parse>>} Existing row. */
    ...
    preload: () => ({
      /** @param {Record<string, ReturnType<typeof JSON.parse>>} conditions - Where conditions. @returns {ReturnType<typeof JSON.parse>} Chainable query. */
      where: (conditions) => ({
