...
- MySQL/MariaDB migrations default implicit `DATETIME` precision to milliseconds while preserving explicit precision, and MSSQL advisory-lock requests reserve one physical session through acquire, release, and cleanup.
