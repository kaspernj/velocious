...
frontend/local resource wrappers can derive the same configuration. Frontend
resource generics and `FrontendModelResourceClassType` now preserve the bound
frontend model class without casting it to a backend database record class.
