...
export type BeaconHelloMessage = {
    type: "hello";
    role: BeaconSocketRole;
    peerId: string;
    peerType?: string;
};
export type BeaconHelloAckMessage = {
    type: "hello-ack";
    peerId: string;
};
export type BeaconBroadcastMessage = {
    type: "broadcast";
    channel: string;
...
export type BeaconSocketMessage = BeaconHelloMessage | BeaconHelloAckMessage | BeaconBroadcastMessage;
/**
