export type SyncPublishBroadcastArgs = {
    /**
     * - Payload snapshotted through the declaration's `serialize(record)` at mutation time.
     */
    data: Record<string, ReturnType<typeof JSON.parse>>;
    /**
     * - Mutation operation that published.
     */
    operation: "create" | "update" | "destroy";
    /**
     * - Mutated server model record.
     */
    ...
    resourceType: string;
    /**
     * - Upserted sync/change row.
     */
    syncRow: ReturnType<typeof JSON.parse>;
    /**
     * - Published sync type ("update" for creates/updates, "delete" for destroys).
     */
    syncType: string;
};
export type SyncPublishBroadcast = {
    /**
     * - Channel name or resolver.
     */
    channel: string | ((args: SyncPublishBroadcastArgs) => string);
    /**
     * - Channel routing params.
     */
    broadcastParams: (args: SyncPublishBroadcastArgs) => Record<string, ReturnType<typeof JSON.parse>>;
    /**
     * - Broadcast body.
     */
    body: (args: SyncPublishBroadcastArgs) => ReturnType<typeof JSON.parse>;
    /**
     * - Optional gate; skipped when it returns false.
     */
    when?: (args: SyncPublishBroadcastArgs) => boolean;
};
export type SyncPublishDeclarationConfig<TModel = any> = {
    /**
     * - Builds the published payload snapshot from the mutated record (snapshotted at mutation time). Defaults to the record's attributes with Date values serialized to ISO strings.
     */
     ...
     */
    eventId?: string | ((record: TModel) => string | number | null | Promise<string | number | null>);
    /**
     * - Deprecated: declarative app-channel broadcasts fanned out after the framework sync channel broadcast. The framework broadcast happens automatically; keep this only for legacy channels old app versions still subscribe.
     */
    broadcasts?: SyncPublishBroadcast[];
    /**
     * - Published operations. Defaults to creates and updates; destroys are opt-in because a server destroy is often cleanup rather than a synced delete.
     */
    operations?: Array<"create" | "update" | "destroy">;
    /**
     * - Published resource type. Defaults to the model name.
     */
    resourceType?: string;
};
...
export type SyncPublisherOptions = {
    /**
     * - Sync model column linking rows to a device actor. Published server-origin rows set it to null (no device to echo). Defaults to "authentication_token_id".
     */
    actorForeignKeyColumn?: string;
    /**
     * - Delivers the framework sync channel broadcast and any deprecated declared broadcasts. Defaults to the configuration's channel broadcast.
     */
    ...
    /**
     * - Configuration owning the registered models. Defaults to the current configuration.
     */
    configuration?: import("../configuration.js").default;
    /**
     * - Reports post-commit publish failures. Defaults to loud logging.
     */
    onError?: (error: Error) => void;
    /**
     * - Sync/change model override. Defaults to the registered "Sync" model.
     */
    syncModel?: ReturnType<typeof JSON.parse>;
};
export type SyncPublisherScopePlanEntry = {
    /**
     * - Sync-row column persisting the scope value.
     */
    columnName: string;
    /**
     * - Record attribute read for the scope value, or null when the record's own id is the scope (scope-root models).
     */
    recordAttribute: string | null;
    /**
     * - Deprecated eventId resolver function.
     */
    resolver: ((record: ReturnType<typeof JSON.parse>) => string | number | null | Promise<string | number | null>) | undefined;
    /**
     * - Scope attribute name broadcast as the framework channel scoping param.
     */
    scopeAttribute: string;
};
export type SyncPublisherResourceConfig = {
    /**
     * - Deprecated declared app-channel broadcasts.
     */
    broadcasts: SyncPublishBroadcast[] | undefined;
    /**
     * - Server model class for this resource.
     */
    ...
    /**
     * - Payload snapshot builder (the declaration's serialize or the default attribute serializer).
     */
    serialize: (record: ReturnType<typeof JSON.parse>) => Record<string, ReturnType<typeof JSON.parse>> | Promise<Record<string, ReturnType<typeof JSON.parse>>>;
    /**
     * - Published resource type.
     */
    resourceType: string;
 ...
 * @property {Record<string, ReturnType<typeof JSON.parse>>} data - Payload snapshotted through the declaration's `serialize(record)` at mutation time.
 * @property {"create" | "update" | "destroy"} operation - Mutation operation that published.
 * @property {ReturnType<typeof JSON.parse>} record - Mutated server model record.
 * @property {string} resourceId - Published resource id.
 * @property {string} resourceType - Published resource type.
 * @property {ReturnType<typeof JSON.parse>} syncRow - Upserted sync/change row.
 ...
 * @property {(args: SyncPublishBroadcastArgs) => Record<string, ReturnType<typeof JSON.parse>>} broadcastParams - Channel routing params.
 * @property {(args: SyncPublishBroadcastArgs) => ReturnType<typeof JSON.parse>} body - Broadcast body.
 ...
 * @property {(broadcast: {channel: string, params: Record<string, ReturnType<typeof JSON.parse>>, body: ReturnType<typeof JSON.parse>}) => Promise<void>} [broadcaster] - Delivers the framework sync channel broadcast and any deprecated declared broadcasts. Defaults to the configuration's channel broadcast.
 ...
 * @property {ReturnType<typeof JSON.parse>} [syncModel] - Sync/change model override. Defaults to the registered "Sync" model.
 */
/**
 ...
 * @property {((record: ReturnType<typeof JSON.parse>) => string | number | null | Promise<string | number | null>) | undefined} resolver - Deprecated eventId resolver function.
 ...
 */
export {};
//# sourceMappingURL=sync-publisher-types.d.ts.map