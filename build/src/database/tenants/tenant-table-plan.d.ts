export type TenantTablePlanEntry = {
    /**
     * Name of the table whose rows are partitioned by tenant.
     */
    tableName: string;
    /**
     * Column matched directly against the tenant key value.
     */
    keyColumn?: string;
    /**
     * Earlier-in-plan table whose selected rows scope this one.
     */
    parentTableName?: string;
    /**
     * Column on this table referencing the parent table's primary key.
     */
    parentColumn?: string;
};
/**
 ...
 */
export {};
//# sourceMappingURL=tenant-table-plan.d.ts.map