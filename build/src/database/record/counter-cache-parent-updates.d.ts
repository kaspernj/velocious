export type CounterCacheParentUpdateListener = (parent: import("./index.js").default, previousParent: import("./index.js").default | undefined) => void | Promise<void>;
export type PreparedCounterCacheParentUpdate = {
    canonicalParentModelClass: typeof import("./index.js").default;
    listeners: CounterCacheParentUpdateListener[];
    ...
    previousParent: import("./index.js").default | undefined;
};
/**
 ...
 */
export declare function prepareCounterCacheParentUpdate({ parentId, parentModelClass, parentPrimaryKey, parentQuery }: {
    parentId: ReturnType<typeof JSON.parse>;
    parentModelClass: typeof import("./index.js").default;
    parentPrimaryKey: string;
    parentQuery: import("../query/model-class-query.js").default<typeof import("./index.js").default>;
}): Promise<PreparedCounterCacheParentUpdate | undefined>;
/**
 ...
 */
export declare function scheduleCounterCacheParentUpdate({ preparedUpdate, sourceRecord }: {
    preparedUpdate: PreparedCounterCacheParentUpdate | undefined;
