...
Do not edit `CHANGELOG.md` directly; add changelog fragments to `changelog.d/YYYYMMDD-short-slug.md` instead. Fragments are aggregated into `CHANGELOG.md` during releases.
